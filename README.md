...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-customer-self-service?sort=semver)](https://github.com/liberusoftware/module-crm-customer-self-service/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-customer-self-service/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-customer-self-service/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-customer-self-service
```
...
<a href="https://github.com/liberusoftware/module-crm-customer-self-service/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-customer-self-service" alt="Contributors to liberusoftware/module-crm-customer-self-service">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-customer-self-service/graphs/contributors).
